package
{
	...
	public class LineAndCurveDrawing extends Sprite
	{
		...
		private var jumplineCommands:Vector.<int> = new Vector.<int>();
		...
		public function LineAndCurveDrawing()
		{
			...
			jumplineCommands.push(GraphicsPathCommand.MOVE_TO);
			jumplineCommands.push(GraphicsPathCommand.WIDE_LINE_TO);
			jumplineCommands.push(GraphicsPathCommand.WIDE_LINE_TO);
			jumplineCommands.push(GraphicsPathCommand.WIDE_LINE_TO);
			jumplineCommands.push(GraphicsPathCommand.WIDE_LINE_TO);
			...
			graphics.lineStyle(0, 0x336699);
			graphics.drawPath(jumplineCommands, data);
