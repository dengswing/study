 ...
 */	 
	public class TweenLite extends Tweenable {
		...
		/** @private **/
		public static const version:Number = 11.0988;
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------
		...
		/**
		 * Kills a particular tween, stopping it immediately and removing it from the timeline.
		 *  
		 * @param $tween TweenLite or TweenMax instance to remove
		 */
		public static function removeTween($tween:TweenLite):void {
			if ($tween != null) {
