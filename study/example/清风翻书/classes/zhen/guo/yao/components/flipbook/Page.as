	...
	internal class Page extends Sprite 
	{
		...
		private function currentLoadComHandler(evn:Event):void
		{
			if (!_currentLoaderClosed)
			{
				if (_targetPageType=="jump_next")
				{
					...
					_nextPageContainer.addChild(_currentPageLoader.content);
				...
				else if(_targetPageType=="jump_prev")
				{
					...
					_prevPageContainer.addChild(_currentPageLoader.content);
				...
				{
					_currentPageContainer.addChild(_currentPageLoader.content);
		...
		private function nextLoadComHandler(evn:Event):void
		{
			if (!_nextLoaderClosed)
			{
				if (_nextPageContainer.numChildren == 0)
				{
					_nextPageContainer.addChild(_nextPageloader.content);
		...
		private function prevLoadComHandler(evn:Event):void
		{
			if (!_prevLoaderClosed)
			{
				if (_prevPageContainer.numChildren == 0)
				{
					_prevPageContainer.addChild(_prevPageloader.content);
