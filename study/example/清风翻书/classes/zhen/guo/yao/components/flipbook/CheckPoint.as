package zhen.guo.yao.components.flipbook
{
	...
	{		
		...
		function checkPageAngle(cPoint:Point, dPoint:Point):void
		{
		...
		private function pageFirstMoveCompleteHandler():void
		{
			...
			{
				case HotName.RIGHT_DOWN:
				    TweenLite.to(_targetPoint, 1, {x:0, y:_pageHeight, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
				case HotName.RIGHT_UP:
				    TweenLite.to(_targetPoint, 1, {x:0, y:0, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
				case HotName.LEFT_DOWN:
				    TweenLite.to(_targetPoint, 1, {x:_pageWidth, y:_pageHeight, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
				case HotName.LEFT_UP:
				    TweenLite.to(_targetPoint, 1, {x:_pageWidth, y:0, ease:Circ.easeOut,onUpdate:pageMovingHandler,onComplete:pageMoveCompleteHandler });
				    break;
			}
